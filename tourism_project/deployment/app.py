...
st.write("""
This application predicts the likelihood of a customer purchasing a tourism package based on customer details.""")
...
if st.button("Predict Purchase"):
    ...
    if prediction == 1:
      result = "Customer is unlikely to purchase tourism package"
    else:
      result = "Customer is likely to purchase tourism package"
